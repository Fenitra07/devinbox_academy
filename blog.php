                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hero-cap hero-cap2 text-center">
                                <h2>Retrouver ici les dernières actualités sur le monde de l'informatique</h2>
                            </div>
                        </div>
                    </div>
                </div>
                  ...
                  ?>
                            <article class="blog_item">
                                ...
                                <div class="blog_details">
                                    <a class="d-inline-block" href="blog_voir.php?id=<?php echo $row['id_article']; ?>">
                                    ...
                                    <div class="post-btn">
                                        <a href="blog_voir.php?id=<?php echo $row['id_article']; ?>">
                                            <button style="margin-left: 500px;" class="genric-btn info-border radius">En savoir plus</button>
                                        </a>
                                    </div>
                                </div>
                            </article>
