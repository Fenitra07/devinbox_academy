...
<body>
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-6 col-lg-7 col-md-8">
                                <div class="hero__caption">
                                    <span data-animation="fadeInLeft" data-delay=".2s">Développons ensemble la culture digitale</span>
                                    <h1 data-animation="fadeInLeft" data-delay=".4s">Apprenez aujourd'hui les compétences de demain</h1>
                                    <!-- Hero-btn -->
                                    <div class="hero__btn">
                                        <a href="cours_en_presentiel.html" class="btn hero-btn"  data-animation="fadeInLeft" data-delay=".8s">Commencer maintenant</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row justify-content-sm-center">
                    <div class="cl-xl-7 col-lg-8 col-md-10">
                        ...
                        <div class="section-tittle text-center mb-70">
                            <h2>Parcourir toutes les catégories</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat mb-50">
                            ...
                            <div class="cat-cap">
                                ...
                                <p style="text-align: justify;">Apprendre à concevoir des interfaces ergonomiques et responsives tout en étant performantes.</p>
                                <a href="cours_en_presentiel.html" class="read-more1">Consulter les cours ></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat mb-50">
                            ...
                            <div class="cat-cap">
                                ...
                                <p style="text-align: justify;">Apprendre à concevoir des applications web en utilisant les technologies les plus adaptées.</p>
                                <a  href="cours_en_presentiel.html" class="read-more1">Consulter les cours ></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a  href="">DevOps</a></h5>
                                <p style="text-align: justify;">Apprendre à utiliser les méthodes et les outils collaboratifs pour une meilleure gestion de votre projet.</p>
                                <a  href="cours_en_presentiel.html" class="read-more1">Consulter les cours ></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat mb-50">
                            ...
                            <div class="cat-cap">
                                ...
                                <p style="text-align: justify;">Apprendre à manipuler les outils et l'environnement de développement pour une configuration optimale des ressources.</p>
                                <a  href="cours_en_presentiel.html" class="read-more1">Consulter les cours ></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a  href="">Process & autonomy</a></h5>
                                <p style="text-align: justify;">Apprendre à mettre en place des processus logiques, automatisés, optimisés et réutilisables pour gagner en efficacité.</p>
                                <a  href="cours_en_presentiel.html" class="read-more1">Consulter les cours ></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a  href="#">Method & creativity</a></h5>
                                <p style="text-align: justify;">Apprendre les nouvelles méthodes de programmation et approches collaboratives afin de fluidifier le processus de développement.</p>
                                <a  href="cours_en_presentiel.html" class="read-more1">Consulter les cours ></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="browse-btn2 text-center mt-50">
                            <a href="cours_en_presentiel.html" class="btn">Consulter tous les cours</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    ...
                                    <div class="single-counter text-center">
                                        ...
                                        <span class="counter color-blue">190</span>
                                        <p class="color-blue">+ Formées</p>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <!-- Counter Up -->
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    ...
                                    <div class="single-counter text-center">
                                        ...
                                        <span class="counter color-red">190</span>
                                        <p class="color-red">+ Membres</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <?php
     if ($conn) {
      ...
      $sql = "SELECT * FROM article ORDER BY id_article DESC LIMIT  $commencement, $nbliste";
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="<?php echo 'upload/'.$row['image_art'] ?>" alt="">
                                    <!-- Blog date -->
                                    <div class="blog-date text-center">
                                        <!-- <span><?php echo $row['date_pub_art']; ?></span> -->
                                        <p><?php echo $row['date_pub_art']; ?></p>
                                    </div>
                                </div>
                                <div class="blog-cap">
                                    <p>|   <?php echo $row['thematique_art']; ?></p>
                                    <h3><a href="blog_voir.php?id=<?php echo $row['id_article']; ?>"><?php echo $row['titre_art']; ?></a></h3>
                                    <a class="more-btn" href="blog_voir.php?id=<?php echo $row['id_article']; ?>">Voir plus...</a>
                                </div>
                            </div>
                        </div>
                    </div>
